...
#   3. The benchmark runner can compare raw `mlx-lm`, `mlx_lm.server`, and this project.
#   4. The generated benchmark report contains measured latency and observability/control comparison text.
#
...
grep -q 'latency_overhead_ms' "$REPORT_PATH"
